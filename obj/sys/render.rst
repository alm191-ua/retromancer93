...
Hexadecimal [16-Bits]
                              ...
                              5 
   7D64                       6 sys_render_init:
   7D64 0E 00         [ 7]    7     ld      c, #0
   7D66 CD 99 87      [17]    8     call    cpct_setVideoMode_asm
                              9 
   7D69 21 00 73      [10]   10     ld      hl, #_g_palette
   7D6C 11 10 00      [10]   11     ld      de, #16
   7D6F CD 9E 7D      [17]   12     call    cpct_setPalette_asm
                             13 
   ...
   7D72 21 10 14      [10]    2    ld   hl, #0x1410         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
   7D75 CD BD 7D      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
                             15 
   7D78 C9            [10]   16     ret
                             17 
                             ...
                             24 ;;
   7D79                      25 sys_render_update::
                             26     ;; check render bit
   7D79 DD 7E 01      [19]   27     ld      a, e_comp (ix)
   7D7C E6 04         [ 7]   28     and     #e_cmp_render
   7D7E C8            [11]   29     ret     z
                             30     
   7D7F 11 00 C0      [10]   31     ld      de, #0xC000
   7D82 DD 7E 02      [19]   32     ld      a, e_x(ix)
   7D85 4F            [ 4]   33     ld      c, a
   7D86 DD 7E 03      [19]   34     ld      a, e_y(ix)
   7D89 47            [ 4]   35     ld      b, a
   7D8A CD AA 88      [17]   36     call    cpct_getScreenPtr_asm
   7D8D EB            [ 4]   37     ex      de, hl
                             38     
   7D8E DD 6E 04      [19]   39     ld      l, e_sprite  (ix)
   7D91 DD 66 05      [19]   40     ld      h, e_sprite+1(ix)
   7D94 DD 46 0E      [19]   41     ld      b, e_h(ix)
   7D97 DD 4E 0F      [19]   42     ld      c, e_w(ix)
   7D9A CD 7A 86      [17]   43     call    cpct_drawSprite_asm
                             44 
   7D9D C9            [10]   45     ret
                             46 
                             47 
