...
Hexadecimal [16-Bits]
                              ...
                              3 
   40C1                       4 tmpl_enemy_void:
   40C1 03                    5     .db  type_enemy_void      ;Tipo del enemigo
   40C2 1F                    6     .db e_cmp_ia | e_cmp_movable | e_cmp_render | e_cmp_animated | e_cmp_collider 
   40C3 00                    7     .db 0                     ; X
   40C4 4B                    8     .db LANE1_Y               ; Y
   40C5 00 00                 9     .dw 0x0000                ; Sprite (TODO)
   40C7 00 00                10     .dw 0x0000                ; Funcion de la IA (TODO)
   40C9 00 00                11     .dw 0x0000                ; Animacion (TODO)
   40CB 00                   12     .db 0                      ; anim_counter (todo)
   40CC 05                   13     .db type_trigger           ; collides_against    
                             14 
   40CD                      15 tmpl_enemy_o:
   40CD 01                   16     .db  type_enemy_o       ;Tipo del enemigo
   40CE 1F                   17     .db e_cmp_ia | e_cmp_movable | e_cmp_render | e_cmp_animated | e_cmp_collider 
   40CF 00                   18     .db 0                     ; X
   40D0 4B                   19     .db LANE1_Y               ; Y
   40D1 00 00                20     .dw 0x0000                ; Sprite (TODO)
   40D3 00 00                21     .dw 0x0000                ; Funcion de la IA (TODO)
   40D5 00 00                22     .dw 0x0000                ; Animacion (TODO)
   40D7 00                   23     .db 0                      ; anim_counter (todo)
   40D8 05                   24     .db type_trigger           ; collides_against    
                             25 
   40D9                      26 tmpl_enemy_p:
   40D9 02                   27     .db  type_enemy_p       ;Tipo del enemigo
   40DA 1F                   28     .db e_cmp_ia | e_cmp_movable | e_cmp_render | e_cmp_animated | e_cmp_collider 
   40DB 00                   29     .db 0                     ; X
   40DC 4B                   30     .db LANE1_Y               ; Y
   40DD 00 00                31     .dw 0x0000                ; Sprite (TODO)
   40DF 00 00                32     .dw 0x0000                ; Funcion de la IA (TODO)
   40E1 00 00                33     .dw 0x0000                ; Animacion (TODO)
   40E3 00                   34     .db 0                      ; anim_counter (todo)
   40E4 05                   35     .db type_trigger           ; collides_against 
                             36 
   40E5                      37 tmpl_player:
   40E5 04                   38     .db type_player       ;Tipo del enemigo
   40E6 1E                   39     .db e_cmp_movable | e_cmp_render | e_cmp_animated | e_cmp_collider 
   40E7 00                   40     .db 0                     ; X
   40E8 4B                   41     .db LANE1_Y               ; Y
   40E9 00 00                42     .dw 0x0000                ; Sprite (TODO)
   40EB 00 00                43     .dw 0x0000                ; Funcion de la IA (TODO)
   40ED 00 00                44     .dw 0x0000                ; Animacion (TODO)
   40EF 00                   45     .db 0                      ; anim_counter (todo)
   40F0 00                   46     .db 0                      ; collides_against 
