...
Hexadecimal [16-Bits]
   ...
   4090                      25 _wait:
                             26    ; halt
                             27    ; halt
   4090 CD 32 42      [17]   28    call  cpct_waitVSYNC_asm
   4093 C9            [10]   29    ret
                             30 
   4094                      31 retromancer:
                             32    ;; INIT MANAGER AND RENDER
                             33 
   4094 CD 01 41      [17]   34    call man_entity_init
   4097 CD AD 40      [17]   35    call sys_render_init
                             36 
   409A 21 3D 41      [10]   37    ld hl, #tmpl_enemy_void
   409D CD 15 41      [17]   38    call man_entity_create
                             39 
   40A0 CD C2 40      [17]   40    call sys_render_update
                             41    
                             42    ;;
                             43    ;;MAIN LOOP
                             44    ;;
   40A3                      45  _main_loop:
                             46    ; Update Systems
                             47    ;SysUpdate physics
                             48    ;call sys_generator_update
                             49    ; SysUpdate generator
                             50    ;SysUpdate render
                             51    ; Update Entity Manager
                             52    ;call man_entity_update
                             53 
   40A3 CD 90 40      [17]   54    call _wait
   40A6 18 FB         [12]   55    jr _main_loop
                             56 
   40A8                      57 _main::
                             58 
   40A8 CD 47 42      [17]   59    call  cpct_disableFirmware_asm
   40AB 18 E7         [12]   60    jr    retromancer
