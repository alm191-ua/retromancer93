...
Hexadecimal [16-Bits]
                              ...
                              8 
                              9 .area _DATA
   7800 50 52 45 53 53 20    10 string: .asciz "PRESS ANY BUTTON TO START"
        41 4E 59 20 42 55
        54 54 4F 4E 20 54
        4F 20 53 54 41 52
        54 00
   ...
   7110                      23 _wait:
                             24    ; halt
   7110 CD 71 77      [17]   25    call  cpct_waitVSYNC_asm
   7113 C9            [10]   26    ret
                             27 
   ...
   7116 2E 04         [ 7]   32    ld   l, #04  ;; Set Foreground PEN to 3 (Blue)
                             33 
   7118 CD 8A 77      [17]   34    call cpct_setDrawCharM0_asm ;; Set up colours for drawn characters in mode 0
                             35 
   ...
   711B FD 21 00 78   [14]   38    ld   iy, #string ;; IY = Pointer to the start of the string
   711F 21 80 C2      [10]   39    ld   hl, #0xC280  ;; HL = Pointer to video memory location where the string will be drawn
                             40 
   7122 CD 23 76      [17]   41    call cpct_drawStringM0_asm ;; Call the string drawing function
                             42 
   7125                      43    loop_start_game:
   7125 CD BF 77      [17]   44       call    cpct_scanKeyboard_asm
   7128 CD 57 77      [17]   45       call    cpct_isAnyKeyPressed_asm
   ...
   7131 2E 00         [ 7]   51       ld   l, #00  ;; Set Foreground PEN to 3 (Blue)
                             52 
   7133 CD 8A 77      [17]   53       call cpct_setDrawCharM0_asm ;; Set up colours for drawn characters in mode 0
                             54 
   ...
   7136 FD 21 00 78   [14]   57       ld   iy, #string ;; IY = Pointer to the start of the string
...
Hexadecimal [16-Bits]
                             ...
                             59 
   713D CD 23 76      [17]   60       call cpct_drawStringM0_asm ;; Call the string drawing function
   ...
   7142 DD 21 5C 75   [14]   73    ld    ix, #tmpl_enemy_o
   7146 CD C4 74      [17]   74    call  man_enemy_create
   0039                      75    ld__ixh_d
   ...
   7155 CD 9E 73      [17]   80    call  sys_render_update
                             81 
                             82    ; create enemy lane 2
   7158 DD 21 6C 75   [14]   83    ld    ix, #tmpl_enemy_p
   715C CD C4 74      [17]   84    call  man_enemy_create
   004F                      85    ld__ixh_d
   ...
   7167 CD 9E 73      [17]   88    call  sys_render_update
                             89    
                             90    ;;
                             91    ;;MAIN LOOP
                             92    ;;
   716A                      93  _main_loop:
   716A CD D3 75      [17]   94    call sys_game_play
                             95 
   716D CD 10 71      [17]   96    call _wait
   7170 18 F8         [12]   97    jr _main_loop
                             98 
   7172                      99 _main::
   7172 CD 79 77      [17]  100    call  cpct_disableFirmware_asm
   7175 CD 9F 75      [17]  101    call  sys_game_init
